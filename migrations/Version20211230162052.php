 ...
 */
final class Version20211230162052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comentarios DROP fecha_publicacion');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comentarios ADD fecha_publicacion DATETIME NOT NULL');
